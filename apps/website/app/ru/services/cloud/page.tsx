...
const fallback: MappedServiceContent = {
  ...
  features: [
    { icon: 'icon1', title: 'Рабочие процессы миграции без простоев в AWS и Azure' },
    { icon: 'icon2', title: 'Гарантированное соблюдение требований TRA ОАЭ по локализации данных' },
    { icon: 'icon3', title: 'Проактивный Cloud FinOps для максимального снижения затрат' },
    { icon: 'icon4', title: 'Шифрование военного уровня и автоматизированное аварийное восстановление' },
    { icon: 'icon5', title: 'Круглосуточный локальный мониторинг SOC из нашей штаб-квартиры в Дубае' },
  ],
  secondSection: [
    {
  ...
  faq: [
    ...
    { question: 'Можете ли вы снизить наши текущие счета за AWS или Azure?', answer: 'Абсолютно. Используя стратегии Cloud FinOps, мы обычно сокращаем ежемесячные счета наших клиентов за вычисления на 30–50%.' },
    { question: 'Что такое гибридное облако и нужно ли оно нам?', answer: 'Гибридное облако объединяет ваши физические локальные серверы с публичными облаками, такими как AWS. Это критически важно для банков или подрядчиков, которым необходимо хранить данные локально.' },
  ],
  faqTitle: 'Часто Задаваемые Вопросы о Миграции в Облако',
  cta: {
  ...
  relatedServices: [
    { title: 'Кибербезопасность', url: '/ru/services/cybersecurity', description: 'Архитектура Zero Trust и защита облачных конечных точек.' },
    { title: 'Стратегический ИТ Консалтинг', url: '/ru/services/it-consulting', description: 'Выбор вендоров и дорожные карты цифровой трансформации.' },
    { title: 'Управляемые ИТ Услуги', url: '/ru/services/managed-it', description: 'Круглосуточный NOC мониторинг вашей новой облачной среды.' },
  ],
};
...
export default async function CloudPage() {
  const service = await getService('cloud', 'ru');
