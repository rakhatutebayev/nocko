...
export const metadata: Metadata = {
  title: 'ИТ Компания в Шардже | ИТ Поддержка Шарджа | NOCKO',
  description:
  ...
  openGraph: {
    title: 'ИТ Компания в Шардже | ИТ Поддержка | NOCKO',
    description:
      ...
      <StructuredData
        ...
        data={{
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Шарджа', item: `${baseUrl}/ru/locations/sharjah` },
          ],
        }}
      />
      <HeaderWrapper />
