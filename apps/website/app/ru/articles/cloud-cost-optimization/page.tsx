...
const faqItems = [
  {
    question: "Как быстро мы увидим снижение расходов после начала работы?",
    answer: "Устранение потерь даёт результат уже в первом расчётном периоде. Экономия от Reserved Instances начинается со второго месяца — AWS и Azure применяют скидки с даты фиксации обязательства.",
  },
  {
    question: "Нужно ли менять архитектуру приложений, чтобы сэкономить?",
    answer: "Не обязательно. Большинство экономии достигается за счёт оптимизации размеров, покупки RI и устранения потерь — это исключительно инфраструктурные изменения, не требующие правок кода приложений.",
  },
  {
    question: "Каков реалистичный процент снижения расходов?",
    answer: "Для компаний, которые никогда не занимались FinOps, 30–50% достижимо в течение 90 дней. Компании, уже использующие RI, как правило, получают дополнительно 10–20% экономии через Savings Plans.",
  },
];
