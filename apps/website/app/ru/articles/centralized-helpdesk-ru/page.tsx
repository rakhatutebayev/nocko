...
export const metadata: Metadata = {
  ...
  description:
    'NOCKO — русскоговорящая ИТ компания в Дубае. Централизованный Helpdesk 24/7, русскоговорящие ИТ специалисты и полная ИТ-поддержка бизнеса в ОАЭ на родном языке.',
  keywords:
...
const articleData = {
  hero: {
    ...
    subtitle: 'ИТ-поддержка на родном языке: русскоговорящие специалисты, SLA и мгновенное реагирование',
