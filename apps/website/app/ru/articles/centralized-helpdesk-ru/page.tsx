...
const articleData = {
  hero: {
    title: 'ИТ Поддержка на Русском в Дубае — Helpdesk 24/7',
    subtitle: 'Техническая поддержка на русском языке: специалисты, SLA и мгновенное реагирование',
    description: 'NOCKO предоставляет ИТ-поддержку на русском языке в Дубае. Без языкового барьера, сертифицированные инженеры и гарантированные SLA для бизнеса в ОАЭ.',
  },
  intro:
