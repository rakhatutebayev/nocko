...
export const metadata: Metadata = {
  title: 'Русскоговорящая ИТ Компания в Дубае — ИТ Специалисты и Аутсорсинг',
  description:
    'NOCKO — русскоговорящая ИТ-компания в Дубае и ОАЭ. Русскоговорящие ИТ специалисты, абонентское ИТ обслуживание (AMC), ИТ аутсорсинг, поддержка 24/7 и приходящий системный администратор для вашего бизнеса.',
  keywords:
    'русскоговорящая ит компания дубай, русскоговорящие ит компании оаэ, русскоговорящие ит специалисты дубай, ит компания дубай на русском, ит аутсорсинг дубай, приходящий системный администратор дубай, абонентское ит обслуживание, IT AMC dubai на русском, ит поддержка оаэ',
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Русскоговорящая ИТ Компания в Дубае — ИТ Специалисты и Аутсорсинг',
    description:
      'Русскоговорящая ИТ-компания в Дубае: абонентское ИТ обслуживание (AMC) для вашего бизнеса. Русскоязычная команда экспертов доступна 24/7.',
    type: 'website',
    locale: 'ru_RU',
...
const itSupportRuContent = {
  hero: {
    title: 'Русскоговорящая ИТ-Компания в Дубае: Поддержка и Helpdesk',
    subtitle: 'Комплексный ИТ аутсорсинг, абонентское обслуживание (AMC) и строгие SLA 24/7',
    description:
      'NOCKO — русскоговорящая ИТ-компания в ОАЭ. Обеспечьте бесперебойную работу вашей команды: русскоязычная поддержка L1/L2/L3, проактивный мониторинг конечных устройств и оперативный выезд инженеров в DIFC, DMCC и по всем ОАЭ.',
    serviceType: 'ИТ Аутсорсинг и Поддержка',
  },
  firstSection: [
    {
    ...
    {
      title: 'Наш приходящий системный администратор в Дубае',
      text: 'Хотя мы решаем 85% проблем удаленно, поломки оборудования и настройка сети с нуля требуют физического присутствия. Если вышел из строя сервер или вам нужен приходящий системный администратор в офис (JLT, Business Bay, DIFC), мы немедленно отправляем сертифицированных специалистов. Мы гарантируем выезд в течение 2 часов для критических сбоев.',
      link: '/articles/centralized-helpdesk-ru',
  ...
  geoContent: {
    ...
    terms: ['Русскоговорящая ИТ компания ОАЭ', 'ИТ Поддержка Дубай', 'Русскоязычный Helpdesk ОАЭ', 'Поддержка Microsoft 365', 'Выездной системный администратор'],
  },
  faq: {
    ...
    items: [
      ...
      {
        question: 'Чем русскоговорящая ИТ-компания в Дубае лучше фрилансера или штатного сисадмина?',
        answer:
          'Русскоговорящие ИТ компании в ОАЭ, такие как NOCKO, дают вам целую команду инженеров (L1–L3) по цене одного специалиста, юридически закрепленные SLA, круглосуточный мониторинг и полную коммуникацию на русском языке — от заявки в Helpdesk до ежемесячных отчетов для руководства. Фрилансер или единственный штатный сисадмин не может гарантировать ни доступность 24/7, ни глубину экспертизы по всем направлениям.',
      },
      {
        question: 'Оказываете ли вы услуги полного ИТ аутсорсинга (IT AMC) для малого бизнеса в Дубае?',
        answer:
          'Да, наша основная специализация — это комплексное абонентское ИТ обслуживание (IT AMC - Annual Maintenance Contract). Мы полностью берем на себя управление ИТ-процессами вашей компании: от Helpdesk для пользователей до защиты серверов и настройки интернет-сетей. Это значительно надежнее и выгоднее, чем нанимать штатного сисадмина.',
      },
    ],
  },
};
