interface WhatsAppFloatingButtonProps {
  phoneE164Digits?: string; // e.g. "971542448888" (no +)
  message?: string;
}
...
export default function WhatsAppFloatingButton({
  phoneE164Digits = '971542448888',
  message = 'Hi! I would like to get IT support in UAE.',
  ...
  return (
    ...
    >
      <span className="whatsapp-fab__icon" aria-hidden="true">
        {/* SVG matches the Click to Chat (style-2) WhatsApp icon used on cubezix.com */}
